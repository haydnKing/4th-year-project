...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{Diagram of the general reaction network for the $i^{\mathrm{th}}$ 
...
\begin{figure}
  \begin{center}
    ...
    \end{subfigure}
  \end{center}
  \caption{An implementation of a NOT gate.
  ...
  \begin{center}
    ...
    \end{subfigure}
  \end{center}
  \caption{An implementation of an OR gate.
    Expression of $A$ or $B$ causes excitation of the output.
...
\begin{figure}
  \begin{center}
    ...
    \end{subfigure}
  \end{center}
  \caption{An implementation of Tabor's bacterial edge detector.
