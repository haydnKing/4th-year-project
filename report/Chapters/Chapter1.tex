...
\section{The Chloroplast and the PPR Family}
...
One such control mechanism is the PPR family of proteins, a class of proteins
which are very common in plants but almost entirely absent in other organisms.
PPR proteins are encoded in the nucleus and are transported to organelles such
as the chloroplast by the cell.
Once in the organelle, PPRs bind to mRNA molecules and modulate the translation
rate of the proteins encoded in the mRNA molecule.
PPRs are a mechanism for the cell nucleus to directly control activity in its 
chloroplasts.

A thorough review of the PPR family is given in section \ref{sec:review_PPR}.
